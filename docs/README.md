...
sweeps, GitHub Actions runner updates, or optional dependency compatibility
checks.

For `rand_mt`, also see:

- [`automations/rand-core.md`](automations/rand-core.md), for optional
  `rand_core` compatibility maintenance.
